...
<template>
  <!-- mobile/tablet -->
  <nav class="flex fixed z-10 bottom-0 gap-4 w-11/12 m-[0_auto] justify-around items-center min-h-[60px] rounded-xl">
    <ul class="--menu-left flex gap-1 flex-1">
      <BaseButton class="bg-espresso rounded-md text-beige">Item</BaseButton>
      <BaseButton class="bg-espresso rounded-md text-beige">Item</BaseButton>
    </ul>

    <NuxtImg width="50" height="50" src="/maplecorner_logo.webp"
      class="rounded-full shadow-[0px_0px_10px_1px_var(--color-beige)]" />
